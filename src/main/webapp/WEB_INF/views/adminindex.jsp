             ...
             <c:forEach var="topic" items="${topic}">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10"> 											
                    <div class="topic-content float-right">
                      <h3><a href="/admintopic?id=${topic.getTopic_id()}"> ${topic.getTitle()}</a></h3> 
                      <div class="topic-info">
                        <a href="/admincategory?category_id=${topic.getCategory_id()}">${topic.getName()}</a> >> <a href="/adminuser?user_id=${topic.getUser_id()}">${topic.getUsername()}</a> >> Posted on  <fmt:parseDate value="${topic.getCreate_date()}"  pattern="yyyy-MM-dd'T'HH:mm" type="both" />             
			  ...
			  <ul class="pagination justify-content-center">
			   ...
			   <c:set var = "minpage" value = "${pagenumber}"/>
			    ...
			    <li class="page-item">
			      <a class="page-link" href="/admin?page=${minpage}">Previous</a>
			    </li>
			    ...
			    <li class="page-item"><a class="page-link" href="/admin?page=${loop.index - 1}">${loop.index}</a></li>
			    ...
			    <li class="page-item">
			      ...
			      <a class="page-link" href="/admin?page=${maxpage}">Next</a>
			    </li>
			  </ul>
			</nav>
