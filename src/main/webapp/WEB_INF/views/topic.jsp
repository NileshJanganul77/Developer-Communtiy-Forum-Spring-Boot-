...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <div class="main-col">
        <div class="block">
          <h1 class="float-left">Welcome to Talking Space  <c:out value=" ${Manick}"></c:out></h1>
                           ...
                           <div class="user-info">
                               <img src="WEB_INF/images/avatar/${TopicJoin.getAvatar()}" alt="" class="avatar float-left">
                                   <ul>
                                       ...
                                       <li><a href="/profile?userid=${TopicJoin.getUser_id() }">Profile</a></li>
                                   </ul>
                          </div>
                       </div>
                       <div class="col-md-10">
                           ...
                           <div class="user-info">
                               <img src="WEB_INF/images/avatar/${replys.getAvatar()}" alt="" class="avatar float-left">
                                   <ul>
                                       ...
                                       <li>
                                       <%-- <c:forEach items="${toprep}" var="toprep">
                                       	${toprep.getToprep()}
                                       </c:forEach>
                                        --%>
                                        
                                        <c:forEach var="tpost" items="${tpost}">
                                        
                                        
                                        <c:choose>
										    <c:when test = "${replys.getRep_user_id() == tpost.getRep_id()}">
			  
										    	${tpost.getTopic_id()} Post
                                       ...
                                       <li><a href="/profile?userid=${replys.getRep_user_id() }">Profile</a></li>
                                   </ul>
                          </div>
                       </div>
                       <div class="col-md-10">
