                ...
                <div class="row">
                  ...
                  <div class="col-md-10"> 											
                    <div class="topic-content float-right"> 
                      ...
                      <a href ="/updatetopic?topic_id=${topic.getTopic_id()}">		<button class ="btn btn-success btn-sm">Update</button> </a>
                      <a href ="/deletetopic?topic_id=${topic.getTopic_id()}">		<button class ="btn btn-danger btn-sm">Delete</button>  </a>
                      	</span> 
